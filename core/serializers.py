...
class NotifyPriceSerializer(serializers.Serializer):
    ...
    url = serializers.URLField(max_length=200, required=True, label="Amazon URL")
    ...
    # Define a field for the content as a CharField with a label
    content = serializers.CharField(max_length=500, required=False, label="Content")
